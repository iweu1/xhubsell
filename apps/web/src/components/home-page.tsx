          ...
          {[
            {
              ...
              title: 'Global Reach',
              description:
                'Connect with buyers and sellers from around the world in one unified marketplace.',
              badge: 'Popular',
            },
            {
              icon: Shield,
              ...
              description:
                'Advanced security measures ensure your transactions are always protected and verified.',
              badge: 'Trusted',
            },
            {
              icon: Zap,
          ...
          <TabsContent value="customers" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage your customer relationships and support tickets.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64 bg-muted rounded-lg flex items-center justify-center">
                  <p className="text-muted-foreground">
                    Customer management interface would be displayed here
                  </p>
                </div>
              </CardContent>
            </Card>
